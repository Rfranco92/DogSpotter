...
var profileQs = require("../data/profileQuestions");

module.exports = function(app){
  //Label comments heading each route are in the same order as the top menu bar options that use them
  ...
  app.get("/finddog/:breed?", function(req, res) {
    ...
    //dogBreed becomes an array which translates to a "where in ('breed1', 'breed2', etc..)" SQL clause
  ...
  app.get("/listdog", isAuthenticated, function(req, res) {
    var hbsObject = {questions:profileQs};
    res.render("listdog", hbsObject);    
  });
